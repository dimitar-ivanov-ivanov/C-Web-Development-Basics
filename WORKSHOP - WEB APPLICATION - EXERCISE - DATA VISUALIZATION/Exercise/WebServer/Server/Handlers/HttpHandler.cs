namespace HTTPServer.Server.Handlers
{
    ...
    public class HttpHandler : IRequestHandler
    {
        ...
        public IHttpResponse Handle(IHttpContext context)
        {
            ...
            try
            {
                //Log in user before entering
                //var annonymousAccessiblePaths = new string[] { LoginRoute, RegisterRoute };

                //if (!annonymousAccessiblePaths.Contains(context.Request.Path) &&
