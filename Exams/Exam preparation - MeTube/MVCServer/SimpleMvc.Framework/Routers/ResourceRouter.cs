namespace SimpleMvc.Framework.Routers
{
    ...
    public class ResourceRouter : IHandleable
    {
        ...
        public IHttpResponse Handle(IHttpRequest request)
        {
            try
            {
                string[] resourcePath = request.Path.Split('/', StringSplitOptions.RemoveEmptyEntries);
                ...
                {
                    folderPath = "/" + resourcePath[resourcePath.Length - 2] + "/" + resourcePath[resourcePath.Length - 1];
                }
