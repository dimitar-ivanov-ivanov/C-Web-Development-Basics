namespace SimpleMvc.Framework.Routers
{
    ...
    public class ControllerRouter : IHandleable
    {
        public IHttpResponse Handle(IHttpRequest request)
        {
            ...
            GetControllerAndActionName(request.Path, ref controllerName, ref actionName);
        ...
        private void GetControllerAndActionName(string requestPath, ref string controllerName, ref string actionName)
        {
            var paths = new Dictionary<string, KeyValuePair<string, string>>()
            {
                {"/",new KeyValuePair<string, string>("Home","Index") },
                {"/register",new KeyValuePair<string, string>("Users","Register") },
                {"/login",new KeyValuePair<string, string>("Users","Login") },
                {"/logout",new KeyValuePair<string, string>("Users","Logout") },
                {"/kittens/all",new KeyValuePair<string, string>("Kittens","All") },
                {"/kittens/add",new KeyValuePair<string, string>("Kittens","Add") }
            };

            if (!paths.ContainsKey(requestPath))
            {
                throw new InvalidOperationException("Invalid URL");
            }

            controllerName = paths[requestPath].Key + "Controller";
            actionName = paths[requestPath].Value;
        }
